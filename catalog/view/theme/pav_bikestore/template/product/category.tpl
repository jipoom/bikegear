...
<div class="product-list"> <div class="row-fluid">
    ...
    <div class="span<?php echo $span;?> product-block">
      ...
      <div class="description"><?php echo substr( strip_tags($product['description']),0,60);?>...</div>
 ...
 <div class="product-filter">
   ...
   <div class="product-compare"><a href="<?php echo $compare; ?>"><?php echo $text_compare; ?></a></div>
  </div>
   <div class="pagination"><?php echo $pagination; ?></div>
  <?php } ?>
