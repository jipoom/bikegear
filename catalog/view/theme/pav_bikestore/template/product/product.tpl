...
<div id="content"><?php echo $content_top; ?>
  ...
  <?php if( $special )  { ?>
    ...
    <div class="span6">
      ...
      <div class="review">
        <div><img src="catalog/view/theme/pav_bikestore/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $reviews; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $text_write; ?></a></div>
	  ...
	  <?php } ?>
        ...
        <?php } ?>
		 ...
		 <div class="compare-wish"><span class="links"><a class="wishlist" onclick="addToWishList('<?php echo $product_id; ?>');"><?php echo $button_wishlist; ?></a>
            <a class="compare" onclick="addToCompare('<?php echo $product_id; ?>');"><?php echo $button_compare; ?></a></span>
		</div>
      <?php if ($price) { ?>
  ...
  $cols = $max_related_column;
	...
	<div class="product-related">
	 <div class="box-heading"><h3> <span><?php echo $tab_related; ?> (<?php echo count($products); ?>)</span></h3></div>
