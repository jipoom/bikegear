 ...
 <?php if($product['recurring']): ?>
          ...
          <tr>
            <td class="image" data-label="<?php echo $column_image; ?>"><?php if ($product['thumb']) { ?>
              ...
              <?php } ?></td>
            <td class="name" data-label="<?php echo $column_name; ?>"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
            ...
            <td class="quantity" data-label="<?php echo $column_quantity; ?>" ><input type="text" name="quantity[<?php echo $product['key']; ?>]" value="<?php echo $product['quantity']; ?>" size="1" />
              &nbsp;
  ...
  <div class="row-fluid">
	<div  class="span9">  
		<div class="buttons clearfix">
			<div class="pull-right right"><a href="<?php echo $checkout; ?>" class="button"><?php echo $button_checkout; ?></a></div>
